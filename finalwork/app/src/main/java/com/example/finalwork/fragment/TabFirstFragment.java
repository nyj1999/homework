...
public class TabFirstFragment extends Fragment implements BannerPager.BannerClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // 构建一个服装列表的瀑布流适配器
        RecyclerStaggeredAdapter adapter = new RecyclerStaggeredAdapter(mContext, GoodsInfo2.getDefaultStag());
        // 设置瀑布流列表的点击监听器
        ...
        // 构建一个市场列表的网格适配器
        RecyclerGridAdapter adapter2 = new RecyclerGridAdapter(mContext, GoodsInfo2.getDefaultGrid());
        // 设置网格列表的点击监听器
